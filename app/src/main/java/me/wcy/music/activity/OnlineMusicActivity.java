...
public class OnlineMusicActivity extends BaseActivity implements OnMoreClickListener, AutoLoadListView.OnLoadListener {
...
//        download((OnlineMusic) parent.getAdapter().getItem(position));
//    }
